...
import { X, Star, ShoppingCart, ShieldCheck, Truck, Send, User } from 'lucide-react';
...
const ProductModal: React.FC<ProductModalProps> = ({ product, isOpen, onClose, onAddToCart, onAddReview }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-5xl overflow-hidden animate-in fade-in zoom-in duration-300 flex flex-col max-h-[90vh]">
        <button 
          onClick={onClose}
        ...
        <div className="flex flex-col md:flex-row h-full overflow-hidden">
          ...
          <div className="w-full md:w-1/2 bg-gray-100 p-8 flex items-center justify-center overflow-hidden">
            <img 
              src={product.image} 
              alt={product.name} 
              className={`w-full max-w-sm object-contain mix-blend-multiply hover:scale-105 transition-transform duration-500 ${isOutOfStock ? 'grayscale opacity-75' : ''}`}
            />
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col overflow-y-auto">
            <div className="p-8 pb-4">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                {isOutOfStock ? (
                  <span className="bg-red-100 text-red-700 px-3 py-1 rounded-lg text-sm font-bold">Out of Stock</span>
                ) : (
                  <span className="bg-green-100 text-green-700 px-3 py-1 rounded-lg text-sm font-bold">In Stock ({product.stock})</span>
                )}
              </div>

              <p className="text-gray-600 mb-8 leading-relaxed">
                {product.description} This premium accessory is designed for durability and performance. 
                Perfectly compatible with modern devices.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="flex items-center gap-3 p-3 border border-gray-100 rounded-xl">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-gray-500">Official support</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 border border-gray-100 rounded-xl">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-gray-500">Orders above ₹499</p>
                  </div>
                </div>
              </div>
            ...
            {/* Reviews Section */}
            <div className="border-t border-gray-100 p-8 bg-gray-50/50 flex-grow">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Customer Reviews</h3>
              
              {/* Add Review Form */}
              <form onSubmit={handleSubmitReview} className="mb-8 bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                ...
                <div className="relative">
                  <textarea 
                    ...
                    required
                  />
                  <button type="submit" className="absolute bottom-2 right-2 p-1.5 bg-gray-900 text-white rounded-md hover:bg-primary transition-colors">
                    <Send size={14} />
                  </button>
                </div>
              </form>
              ...
              <div className="space-y-4">
                {product.reviews.length === 0 ? (
                  <p className="text-center text-gray-500 text-sm">No reviews yet. Be the first to review!</p>
                ) : (
