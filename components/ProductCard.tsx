    ...
    <div className={`group bg-white dark:bg-gray-900 rounded-[24px] sm:rounded-[32px] shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-50 dark:border-gray-800 flex flex-col h-full ${isOutOfStock ? 'opacity-75' : ''}`}>
      ...
      >
        ...
        <button 
            ...
            className="absolute top-2 right-2 bg-white/80 dark:bg-gray-900/80 backdrop-blur p-2 rounded-full shadow-sm z-10"
        >
        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1 z-10">
          ...
          <div className="bg-blue-600 text-white text-[7px] sm:text-[8px] font-black px-2 py-1 rounded-lg flex items-center gap-1 shadow-lg w-fit uppercase tracking-tighter">
      ...
      <div className="p-3 sm:p-5 flex flex-col flex-grow">
        <h3 className="text-sm sm:text-base font-bold text-gray-900 dark:text-white mb-1 line-clamp-1 leading-tight">{product.name}</h3>
        ...
        <div className="mt-auto">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button 
              ...
              className={`w-full py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-lg ${isOutOfStock ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-gray-900 dark:bg-primary text-white hover:scale-[1.02] active:scale-95'}`}
            >
